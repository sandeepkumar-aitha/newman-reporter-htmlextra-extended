...
describe('Newman and htmlextra run from the CLI', function () {
    ...
    it('should correctly generate the html report for a successful run', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request.json -r htmlextra-extended --reporter-export ${outFile} --reporter-displayProgressBar`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
    ...
    it('should correctly generate html report for a formdata POST request', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-post-request-with-formdata.json -r htmlextra-extended --reporter-export ${outFile}`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate html report for a urlencoded POST request', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-post-request-with-urlencoded.json -r htmlextra-extended --reporter-export ${outFile}`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report with a new title for a successful run', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request.json -r htmlextra-extended --reporter-export ${outFile} --reporter-title "My new report title"`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report with test pagination for a successful run', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request.json -r htmlextra-extended --reporter-export ${outFile} --reporter-testPaging`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report for a failed run', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-failing-request.json -r htmlextra-extended --reporter-export ${outFile}`,
            function (code) {
    ...
    it('should correctly generate the html report showing only the requests with failed tests', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-failing-request.json -r htmlextra-extended --reporter-export ${outFile} --reporter-showOnlyFails`,
            function (code) {
                expect(code, 'should have exit code of 1').to.equal(1);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly produce the html report for a collection with an environment file', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-request-with-env.json -e test/requests/simple-env.json -r htmlextra-extended --reporter-export ${outFile}`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly produce the html report for a collection with an environment values shown', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-request-with-env.json -e test/requests/simple-env.json -r htmlextra-extended --reporter-export ${outFile} --reporter-showEnvironmentData`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly produce the html report for a collection with an environment values and hide the specified variable', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-request-with-env.json -e test/requests/simple-env.json -r htmlextra-extended --reporter-export ${outFile} --reporter-showEnvironmentData --reporter-skipEnvironmentVars secretVariable`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report for a collection run for more that 1 iteration', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request.json -r htmlextra-extended --reporter-export ${outFile} -n 3`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report for a successful run and remove a single header', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request-with-headers.json -r htmlextra-extended --reporter-export ${outFile} --reporter-skipHeaders testHeader`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report for a successful run and remove multiple headers', function (done) {
        exec(`${newman} run test/requests/simple-get-request-with-headers.json -r htmlextra-extended --reporter-export ${outFile} --reporter-skipHeaders Testheader,host,ACCEPT`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report when a header is not specified', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request-with-headers.json -r htmlextra-extended --reporter-export ${outFile} --reporter-skipHeaders`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report for a successful run and remove all headers', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request-with-headers.json -r htmlextra-extended --reporter-export ${outFile} --reporter-omitHeaders`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('should correctly generate the html report when a request name is not specified', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-get-request.json -r htmlextra-extended --reporter-export ${outFile} --reporter-hideResponseBody`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('Should correctly generate report for skip folder', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-skipped-folder.json -r htmlextra-extended  --reporter-export ${outFile} --reporter-showFolderDescription  --reporter-skipFolders "folder1,folder4" --iteration-count 10`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
    ...
    it('Should correctly geenrate report for skip requests', function (done) {
        // eslint-disable-next-line max-len
        exec(`${newman} run test/requests/simple-skipped-folder.json -r htmlextra-extended  --reporter-export ${outFile} --reporter-showFolderDescription  --reporter-skipRequests "request1,request2" --iteration-count 10`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.stat(outFile, done);
            });
